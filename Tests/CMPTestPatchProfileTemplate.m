...
@interface CMPTestPatchProfileTemplate : XCTestCase

@end

@implementation CMPTestPatchProfileTemplate
...
- (void)testUpdateProfileTemplate {
    CMPPatchProfileTemplate *template = [[CMPPatchProfileTemplate alloc] initWithScheme:@"test_scheme" host:@"test_host" port:100 apiSpaceID:[CMPTestMocks mockApiSpaceID] profileID:@"test_id" token:[CMPTestMocks mockAuthenticationToken] eTag:@"test_eTag" attributes:@{@"test_attribute" : @"test_value"}];
